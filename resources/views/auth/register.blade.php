                ...
                <div class="card-body">
                    {{--  <form method="POST" action="{{ route('register') }}">  --}}
                        ...
                        <div class="form-group row">
                         ...
                         <div class="form-group row">
                            <label for="phone-number" class="col-md-4 col-form-label text-md-right">{{ __('auth.Phone number') }}</label>

                            <div class="col-md-6">
                                <input id="phone-number" type="text" class="form-control" name="phone_number" required autocomplete="phone_number">
                            </div>
                        </div>
